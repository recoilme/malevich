...
public class ImageCache {
     ...
     * {@link ImageCache#getInstance( ImageCacheParams, boolean)} to fetch an ImageCache
     * instance.
     *
     * @param cacheParams The cache parameters to use to initialize the cache
     */
    private ImageCache(ImageCacheParams cacheParams, boolean debug) {
        this.debug = debug;
        init(cacheParams);
    }
    ...
    public static ImageCache getInstance(ImageCacheParams cacheParams, boolean debug) {
        if (singleton == null) {
            synchronized (ImageCache.class) {
                if (singleton == null) {
                    singleton = new ImageCache(cacheParams, debug);
                }
            }
        }
        return singleton;
